...
judge/run_many.py maps/list_official.txt bin/felina       bin/renamed                  --times 20 --num-threads 10 >results/felina_vs_renamed.txt
...
judge/run_many.py maps/list_official.txt bin/omegastay    bin/zhong                    --times 20 --num-threads 10 >results/omegastay_vs_zhong.txt
judge/run_many.py maps/list_official.txt bin/omegastay    bin/renamed                  --times 20 --num-threads 10 >results/omegastay_vs_renamed.txt
...
judge/run_many.py maps/list_official.txt bin/oh-my-blue   bin/zhong                    --times 20 --num-threads 10 >results/ohmyblue_vs_zhong.txt
judge/run_many.py maps/list_official.txt bin/oh-my-blue   bin/renamed                  --times 20 --num-threads 10 >results/ohmyblue_vs_renamed.txt
...
judge/run_many.py maps/list_official.txt bin/granitestate bin/zhong                    --times 20 --num-threads 10 >results/granitestate_vs_zhong.txt
judge/run_many.py maps/list_official.txt bin/granitestate bin/renamed                  --times 20 --num-threads 10 >results/granitestate_vs_renamed.txt
...
judge/run_many.py maps/list_official.txt bin/babyblue     bin/zhong                    --times 20 --num-threads 10 >results/babyblue_vs_zhong.txt
judge/run_many.py maps/list_official.txt bin/babyblue     bin/renamed                  --times 20 --num-threads 10 >results/babyblue_vs_renamed.txt
...
judge/run_many.py maps/list_official.txt bin/heisenberg   bin/zhong                    --times 20 --num-threads 10 >results/heisenberg_vs_zhong.txt
judge/run_many.py maps/list_official.txt bin/heisenberg   bin/renamed                  --times 20 --num-threads 10 >results/heisenberg_vs_renamed.txt
