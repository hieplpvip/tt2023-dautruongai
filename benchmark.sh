...
judge/run_many.py maps/list_semifinal.txt bin/felina       bin/oh-my-blue               --times 20 --num-threads 10 >results/felina_vs_ohmyblue.txt
judge/run_many.py maps/list_semifinal.txt bin/felina       bin/granitestate             --times 20 --num-threads 10 >results/felina_vs_granitestate.txt
judge/run_many.py maps/list_semifinal.txt bin/felina       bin/babyblue                 --times 20 --num-threads 10 >results/felina_vs_babyblue.txt
judge/run_many.py maps/list_semifinal.txt bin/felina       bin/heisenberg               --times 20 --num-threads 10 >results/felina_vs_heisenberg.txt
judge/run_many.py maps/list_semifinal.txt bin/felina       bin/tahp-estimate-shield-val --times 20 --num-threads 10 >results/felina_vs_tahp.txt
...
judge/run_many.py maps/list_semifinal.txt bin/oh-my-blue   bin/granitestate             --times 20 --num-threads 10 >results/ohmyblue_vs_granitestate.txt
judge/run_many.py maps/list_semifinal.txt bin/oh-my-blue   bin/babyblue                 --times 20 --num-threads 10 >results/ohmyblue_vs_babyblue.txt
judge/run_many.py maps/list_semifinal.txt bin/oh-my-blue   bin/heisenberg               --times 20 --num-threads 10 >results/ohmyblue_vs_heisenberg.txt
judge/run_many.py maps/list_semifinal.txt bin/oh-my-blue   bin/tahp-estimate-shield-val --times 20 --num-threads 10 >results/ohmyblue_vs_tahp.txt
